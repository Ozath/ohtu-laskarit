...
class TestKauppa(unittest.TestCase):
    ...
    def test_kahden_eri_tuotteen_oston_jalkeen_tilisiirto_kutsutaan_oikeilla_arvoilla(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
    ...
    def test_kahden_saman_tuotteen_oston_jalkeen_tilisiirto_kutsutaan_oikeilla_arvoilla(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
        self.kauppa.lisaa_koriin(1)
        self.kauppa.tilimaksu("pekka", "12345")
    ...
    def test_kahden_tuotteen_oston_jalkeen_joista_toista_ei_ole_tilisiirto_kutsutaan_oikeilla_arvoilla(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(2)
    ...
    def test_pyydetaan_uusi_viite_jokaiseen_maksuun(self):
        ...
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
        self.kauppa.tilimaksu("jaakko", "23456")
        self.assertEqual(self.viitegeneraattori_mock.uusi.call_count, 3)

    def test_poista_korista_testikattavuus_sataan_prosenttiin(self):
